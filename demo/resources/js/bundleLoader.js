...
if (__webpack_require__(9)) {
  ...
  var toInteger = __webpack_require__(34);
  var toLength = __webpack_require__(11);
  var toIndex = __webpack_require__(242);
...
(function webpackMissingModule() { throw new Error("Cannot find module \"url-search-params-polyfill\""); }());
...
$export($export.S + $export.F * !__webpack_require__(9), 'Object', { defineProperties: __webpack_require__(219) });
...
var $export = __webpack_require__(0);
var toInteger = __webpack_require__(34);
var aNumberValue = __webpack_require__(226);
var repeat = __webpack_require__(145);
...
var $export = __webpack_require__(0);
var log1p = __webpack_require__(228);
var sqrt = Math.sqrt;
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(20)(proto, TO_PRIMITIVE, __webpack_require__(511));
...
// https://github.com/tc39/proposal-string-pad-start-end
var $export = __webpack_require__(0);
var $pad = __webpack_require__(245);
...
var $export = __webpack_require__(0);
var $values = __webpack_require__(246)(false);
...
__webpack_require__(9) && $export($export.P + __webpack_require__(105), 'Object', {
...
var fround = __webpack_require__(229);
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(628)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
...
var loadJs = function loadJs(filename) {
  var scriptEl = createElement('script', { src: filename });
  document.body.appendChild(scriptEl);
};

var bundlesDropdown = document.querySelector('#bundles');
var contentsDropdown = document.querySelector('#contents');
var currentVersion = new URLSearchParams(window.location.search).get('ver');
var currentContentId = new URLSearchParams(window.location.search).get('contentId');
var currentBundle = currentVersion == null ? 'index.js' : currentVersion + '.index.js';

// step 1. load bundle js
loadJs('./resources/js/' + currentBundle);

// step 2. add change event listener to dropdowns
bundlesDropdown.addEventListener('change', function () {
  var selectedBundle = bundlesDropdown.value;
...
contentsDropdown.addEventListener('change', function () {
  var selectedContentId = contentsDropdown.value;
  var queryParams = new URLSearchParams(window.location.search);
...
fetch('./resources/js/bundles.json').then(function (resp) {
  return resp.json();
}).then(function (_ref) {
  ...
  bundles.forEach(function (bundle) {
    var optionText = bundle === 'index.js' ? '(latest)index.' + latestVersion + '.js' : bundle;

    var bundleOption = createElement('option', {
      value: bundle,
...
fetch('./resources/contents/contents.json').then(function (resp) {
  return resp.json();
}).then(function (_ref2) {
